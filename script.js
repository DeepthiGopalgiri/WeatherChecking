...
function weatherCallback(weatherData){
	...
	document.getElementById('temperature').innerHTML = "Temperature is : " + temp + " Celsius";
	...
	function cloudy(){
		var img = document.getElementById('img1'); //search img1 id previously made 
		//if not previously made search img1 id in html tag
